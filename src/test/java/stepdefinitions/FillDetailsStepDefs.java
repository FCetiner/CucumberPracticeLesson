...
public class FillDetailsStepDefs {
    ...
    public void kullanici_ayrintilari_birinci_bolum_doldurur() {
        ...
        fillDetailsPage.passwordBox.sendKeys("12345");
        Driver.selectByIndex(fillDetailsPage.dayDropdown,4);
        Driver.selectByIndex(fillDetailsPage.monthDropdown,6);
    ...
    fillDetailsPage.firstNameBox.sendKeys("ferhat");
    fillDetailsPage.lastNameBox.sendKeys(Faker.instance().name().firstName());
    fillDetailsPage.companyBox.sendKeys("Tech");
